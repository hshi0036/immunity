jQuery( window ).load( function() {
	...
	jQuery( "body" ).on( "click", "#generate_wpc_shortcode", function() {
		...
		if ( param[ 'max' ] != "" ) {
			jQuery( "#pwpc-shortcode" ).val( '[wpcharts type="' + param[ 'style' ] + '" bgcolor="' + param[ 'bgcolor' ] + '" max="' + param[ 'max' ] + '" legend="' + param[ 'legend' ] + '" titles="' + jQuery( "#pwpc_titles" ).val() + '" values="' + jQuery( "#pwpc_values" ).val() + '"]' );			
		}
		else {
			jQuery( "#pwpc-shortcode" ).val( '[wpcharts type="' + param[ 'style' ] + '" bgcolor="' + param[ 'bgcolor' ] + '" legend="' + param[ 'legend' ] + '" titles="' + jQuery( "#pwpc_titles" ).val() + '" values="' + jQuery( "#pwpc_values" ).val() + '"]' );
		}
		datas[ 'style' ] = param;
